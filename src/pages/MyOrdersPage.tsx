      ...
      <section className="pt-28 pb-6 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            ...
            {/* Custom Tab buttons */}
            <div className="flex gap-2 p-1 bg-[#141210] border border-[#D4A24C]/15 rounded-lg self-start sm:self-auto">
              <button
                onClick={() => setActiveTab('orders')}
                className={`flex items-center gap-2 px-4 py-2 text-xs font-semibold uppercase tracking-wider rounded transition-all duration-300 ${
                  activeTab === 'orders'
