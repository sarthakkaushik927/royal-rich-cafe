...
export function SectionDivider({ className }: SectionDividerProps) {
  return (
    <div className={cn("flex items-center justify-center w-full relative z-20 py-8", className)}>
      <div className="h-[3px] bg-gradient-to-r from-transparent via-[#D4A24C] to-[#D4A24C] flex-1 max-w-[35%]" />
      ...
      <div className="h-[3px] bg-gradient-to-l from-transparent via-[#D4A24C] to-[#D4A24C] flex-1 max-w-[35%]" />
    </div>
  );
}
